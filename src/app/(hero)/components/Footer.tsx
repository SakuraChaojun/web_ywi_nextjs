        ...
        <footer className="bg-white">
            <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div>
                                <h3 className="text-sm/6 font-semibold text-gray-900">Our Services</h3>
                ...
                <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
                    <p className="text-sm/6 text-gray-600">&copy; 加国亿微咨询有限公司  琼ICP备16060150号-2 |  琼公网安备 11010502052133号 网络文化经营许可 2020-2024 Yiwii immigration services All Rights Reserved </p>
                </div>
            </div>
        </footer>
    )
